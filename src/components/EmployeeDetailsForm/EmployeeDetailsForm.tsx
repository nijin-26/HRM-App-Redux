...
const EmployeeDetailsForm: React.FC<IEmployeeDetailsForm> = ({
  ...
  const handlePhotoLabelClick = (e: React.KeyboardEvent<HTMLLabelElement>) => {
    if (e.key === "Enter") {
                ...
                >
                  <div className="flex form-row">
                    <label
                      ...
                      tabIndex={0}
                      onKeyDown={(e) => handlePhotoLabelClick(e)}
                    >
                      <img
                        src={photoId || profilePictureAvatar}
                  ...
                  <div className="flex form-row">
                    ...
                    <div className="form-entry">
                      <CustomSelect
                        name="location"
                        label="Location"
                        options={sortObjByKey(locations, "label")}
                  ...
                  {(isNotAdminEditPage || isAddPage) && (
                    <div className="form-entry checkbox">
                      ...
                      <label htmlFor="isAdmin">Provide Admin Access</label>
                    </div>
                  )}
